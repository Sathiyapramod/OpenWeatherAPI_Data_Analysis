...
function showDetails(arr) {
    ...
    card.style.backgroundColor="#FEBB75";
    card.style.boxShadow = "5px 5px 8px 5px lightgrey";
    card.classList.add("mx-auto","card","rounded-5","align-items-center","col-lg-8","col-sm-12","col-md-6","shadow");
    ...
    btn.style.backgroundColor = "C36B84"
